<?php
require('../init.php');
include(path('controller/contact.php'));
  ...
  <div class="contact-us">
    <div class="container">
      <div class="row justify-content-between">
        <div class="msg col-12 col-md-7  col-lg-6 col-xl-4 mb-3">
        ...
        <div class="gen-info col-12 col-md-5">
          <h2>General Info</h2>
          <div class="g-info">
            <span>842lorem Ion.</span>
            <span>1581Sdeeq Street -Cairo-Egypt</span>
            <span>San Francisco.CA94701</span>
            <span>P..(123)456-7890</span><br><br>
            <span>Recycleing-team</span>
            <span>Recycleing@gmail.com</span>
          </div>
          <div class="blank">
          </div>
        </div>
