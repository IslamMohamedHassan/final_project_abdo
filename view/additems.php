      ...
      <div class="item_form  row g-3 col-lg-10  ">
        ...
        <form class="row g-3">
          ...
          <div class="col-12">
            ...
            <textarea rows="10" class="form-control" placeholder="item description" id="description"></textarea>

          </div>
          <div class="col-12">
            <label for="Item Image" class="form-label">Item Image</label>
            <input type="file" id="item_upload" class="form-control" name="myfile">

          </div>

          <div class="col-12">

            <button type="submit" class="btn btn-primary" onclick="saveitem()"> ِAdd Item</button>
          </div>
        </form>
      </div>
    </div>
