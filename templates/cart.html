...
<head>
  ...
  .orderdetails .card button:hover {
    opacity: 0.7;
  }
...
<div class="orderdetails">
    <div class="container">
        ...
        <div>
            <p class="card price " id="totalprice"></p>
        </div>
        <div class="checkout mb-5">
          <a class="btn checkout-btn" href="ordercheckout.html"> checkout now</a>
        </div>
